...
function getContract(contractName, network, privateKeyOrSigner, apiKey) {
    ...
    switch (contractName) {
        case "Bandada":
            return new contracts.Contract(contractAddress, abi, providerOrWallet);
        case "Semaphore":
            return new contracts.Contract(contractAddress, abi$1, providerOrWallet);
        default:
    ...
    SemaphoreContract.prototype.createGroup = function (groupName, merkleTreeDepth, admin) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        groupId = BigInt(strings.formatBytes32String(groupName));
...
function shortenAddress(address$1, chars) {
    if (chars === void 0) { chars = 4; }
    address$1 = address.getAddress(address$1);
    return "".concat(address$1.substring(0, chars + 2), "...").concat(address$1.substring(42 - chars));
}

exports.BandadaABI = abi;
exports.BandadaContract = BandadaContract;
exports.CONTRACT_ADDRESSES = CONTRACT_ADDRESSES;
exports.SemaphoreABI = abi$1;
...
exports.getSemaphoreContract = getSemaphoreContract;
