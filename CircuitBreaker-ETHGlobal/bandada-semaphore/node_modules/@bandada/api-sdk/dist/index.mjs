...
function getGroups(config) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, request(url$1, config)];
                case 1:
                    groups = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, request(requestUrl, config)];
                case 1:
                    group = _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, request(requestUrl, newConfig)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
var ApiSdk = /** @class */ (function () {
    ...
    function ApiSdk(url, config) {
        if (url === void 0) { url = SupportedUrl.PROD; }
