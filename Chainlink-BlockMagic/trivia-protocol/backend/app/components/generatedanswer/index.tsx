...
export default function GeneratedAnswer({ answer, onButtonClicked }: GeneratedAnswerProps) {
    return (
        <div className="flex flex-col gap-2">
            {/* ... generated answer content ... */}
            <div className="space-y-2">
                <h2 className="text-xl text-green-500 font-semibold tracking-tight">Here is the trivia answer json:</h2>
            </div>
            <textarea
                className="min-h-[200px] border text-black p-3 m-2 rounded"
                id="answer"
                placeholder="The trivia answer will appear here."
                value={answer}
                readOnly
            />
