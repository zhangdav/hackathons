...
export type Sender_orderBy = "id" | "address" | "greetings" | "createdAt" | "greetingCount";
...
> = ResolversObject<{
  greeting?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QuerygreetingArgs, "id" | "subgraphError">
  >;
  greetings?: Resolver<
    Array<ResolversTypes["Greeting"]>,
    ParentType,
    ContextType,
    RequireFields<QuerygreetingsArgs, "skip" | "first" | "subgraphError">
  >;
  sender?: Resolver<
    Maybe<ResolversTypes["Sender"]>,
    ParentType,
    ContextType,
    RequireFields<QuerysenderArgs, "id" | "subgraphError">
  >;
  senders?: Resolver<
    Array<ResolversTypes["Sender"]>,
    ParentType,
    ContextType,
    RequireFields<QuerysendersArgs, "skip" | "first" | "subgraphError">
  >;
...
> = ResolversObject<{
  ...
  greetings?: Resolver<
    Maybe<Array<ResolversTypes["Greeting"]>>,
    ParentType,
    ContextType,
    RequireFields<SendergreetingsArgs, "skip" | "first">
  >;
  createdAt?: Resolver<ResolversTypes["BigInt"], ParentType, ContextType>;
...
> = ResolversObject<{
  greeting?: SubscriptionResolver<
    Maybe<ResolversTypes["Greeting"]>,
    "greeting",
    ParentType,
    ContextType,
    RequireFields<SubscriptiongreetingArgs, "id" | "subgraphError">
  >;
  greetings?: SubscriptionResolver<
    ...
    ParentType,
    ContextType,
    RequireFields<SubscriptiongreetingsArgs, "skip" | "first" | "subgraphError">
  >;
  sender?: SubscriptionResolver<
    Maybe<ResolversTypes["Sender"]>,
    "sender",
    ParentType,
    ContextType,
    RequireFields<SubscriptionsenderArgs, "id" | "subgraphError">
  >;
  senders?: SubscriptionResolver<
    Array<ResolversTypes["Sender"]>,
    "senders",
    ParentType,
    ContextType,
    RequireFields<SubscriptionsendersArgs, "skip" | "first" | "subgraphError">
  >;
...
export function getSdk<C, E>(requester: Requester<C, E>) {
  return {
    GetGreetings(variables?: GetGreetingsQueryVariables, options?: C): Promise<GetGreetingsQuery> {
      return requester<GetGreetingsQuery, GetGreetingsQueryVariables>(
        GetGreetingsDocument,
        variables,
        options,
      ) as Promise<GetGreetingsQuery>;
    },
  };
}
